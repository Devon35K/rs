            ...
            <div class="login-card-body">
                ...
                <form method="POST" action="index.php?page=admin" class="login-form" id="loginForm" novalidate>
                    ...
                    <div style="margin-top: 1rem;">
                        <a href="index.php?page=google-login" class="lf-btn-submit" style="background: #ffffff; color: #1e293b; border: 1px solid #e2e8f0; text-decoration: none; justify-content: center; gap: 0.75rem;">
                            ...
                            <span class="lf-btn-text">Sign in with Google</span>
                        </a>
                    </div>
